...
| # | Function | Key files in dashwallet-ios | DashSync API today | SwiftDashSDK target | SDK | Prio | Effort | Storage migration? |
|---|---|---|---|---|---|---|---|---|
...
| 2 | **Address validation** (paste/scan in Send screen) | `Sources/UI/Payments/Send/Models/DWPaymentInputBuilder.m`, `DWPaymentProcessor.m` | `DSPaymentRequest`, `[NSString isValidDashAddressOnChain:]` | SwiftDashSDK address parser (in Address module) | 🟢 | High | S | None |
