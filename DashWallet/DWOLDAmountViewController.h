...
@class DWOLDAmountViewController;
@class DSPaymentProtocolDetails;

@protocol DWOLDAmountViewControllerDelegate <NSObject>
...
@interface DWOLDAmountViewController : KVOUIViewController

@property (nullable, weak, nonatomic) id<DWOLDAmountViewControllerDelegate> delegate;
