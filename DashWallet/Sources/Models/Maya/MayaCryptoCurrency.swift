...
struct MayaCryptoCurrency: Identifiable, Hashable {
    ...
    static let supportedCoins: [MayaCryptoCurrency] = [
        ...
        MayaCryptoCurrency(id: "ada", code: "ADA", name: "Cardano", mayaAsset: "ADA.ADA", chain: "ADA", iconAssetName: "convert.crypto"),
        MayaCryptoCurrency(id: "eth", code: "ETH", name: "Ethereum", mayaAsset: "ETH.ETH", chain: "ETH", iconAssetName: "maya.coin.eth"),
        MayaCryptoCurrency(id: "moca", code: "MOCA", name: "Mocaverse", mayaAsset: "ETH.MOCA-0X53312F85BBA24C8CB99CFFC13BF82420157230D3", chain: "ETH", iconAssetName: "convert.crypto"),
        ...
        MayaCryptoCurrency(id: "usdt_arb", code: "USDT", name: "USDT", mayaAsset: "ARB.USDT-0XFD086BC7CD5C481DCC9C85EBE478A1C0B69FCBB9", chain: "ARB", iconAssetName: "maya.coin.usdt"),
        MayaCryptoCurrency(id: "yum", code: "YUM", name: "YUM", mayaAsset: "ARB.YUM-0X9F41B34F42058A7B74672055A5FAE22C4B113FD1", chain: "ARB", iconAssetName: "convert.crypto"),
        ...
        MayaCryptoCurrency(id: "sol", code: "SOL", name: "Solana", mayaAsset: "SOL.SOL", chain: "SOL", iconAssetName: "convert.crypto"),
        MayaCryptoCurrency(id: "near", code: "NEAR", name: "NEAR Protocol", mayaAsset: "NEAR.NEAR", chain: "NEAR", iconAssetName: "convert.crypto"),
        MayaCryptoCurrency(id: "trx", code: "TRX", name: "Tron", mayaAsset: "TRON.TRX", chain: "TRON", iconAssetName: "convert.crypto"),
        MayaCryptoCurrency(id: "zec", code: "ZEC", name: "Zcash", mayaAsset: "ZEC.ZEC", chain: "ZEC", iconAssetName: "convert.crypto"),
        MayaCryptoCurrency(id: "xrd", code: "XRD", name: "Radix", mayaAsset: "XRD.XRD", chain: "XRD", iconAssetName: "convert.crypto"),
    ]

    static func coin(for mayaAsset: String) -> MayaCryptoCurrency? {
        let normalizedAsset = mayaAsset.uppercased()

        if normalizedAsset == "DASH.DASH" {
            return nil
        }
