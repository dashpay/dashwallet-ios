...
class MerchantListViewController: ExplorePointOfUseListViewController {
    ...
    override func show(pointOfUse: ExplorePointOfUse) {
        ...
        let vc = PointOfUseDetailsViewController(pointOfUse: pointOfUse, isShowAllHidden: merchant.type == .online, currentFilters: model.filters, currentMapBounds: model.currentMapBounds)
