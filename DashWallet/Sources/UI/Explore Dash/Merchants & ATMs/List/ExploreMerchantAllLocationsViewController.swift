...
@objc class ExploreMerchantAllLocationsViewController: ExplorePointOfUseListViewController {
    ...
    override func show(pointOfUse: ExplorePointOfUse) {
        ...
        if merchant.type == .online {
            ...
            vc = PhysicalMerchantDetailsViewController(merchant: pointOfUse, isShowAllHidden: true)
        }
    ...
    override func configureModel() {
        model = PointOfUseListModel(segments: [.init(tag: 0, title: "", showMap: true, showLocationServiceSettings: false, showReversedLocation: false, dataProvider: AllMerchantsDataProvider())])
    }
