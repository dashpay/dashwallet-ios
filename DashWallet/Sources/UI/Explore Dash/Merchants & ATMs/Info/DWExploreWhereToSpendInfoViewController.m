...
- (void)configureHierarchy {
    ...
    [NSLayoutConstraint activateConstraints:@[
        [contentView.topAnchor constraintEqualToAnchor:self.view.topAnchor
                                              constant:74],
        [contentView.bottomAnchor constraintGreaterThanOrEqualToAnchor:continueButton.topAnchor
                                                              constant:30],
        ...
        [continueButton.bottomAnchor constraintEqualToAnchor:self.view.safeAreaLayoutGuide.bottomAnchor
                                                    constant:-15],
        [continueButton.leadingAnchor constraintEqualToAnchor:self.view.leadingAnchor
                                                     constant:15],
        [continueButton.trailingAnchor constraintEqualToAnchor:self.view.trailingAnchor
                                                      constant:-15],
