...
class MerchantInfoViewController: PointOfUseInfoViewController {
    ...
    override func configureHierarchy() {
        ...
        itemView = merchantTypeView(
            for: NSLocalizedString("Accepts DASH directly", comment: ""),
        ...
        itemView = merchantTypeView(
            for: NSLocalizedString("Buy gift cards with your Dash", comment: ""),
            subtitle: NSLocalizedString("Buy gift cards with your Dash for the exact amount of your purchase.", comment: ""),
        ...
        NSLayoutConstraint.activate(
            [
                ...
                contentView.bottomAnchor.constraint(
                    greaterThanOrEqualTo: continueButton.topAnchor,
                    constant: 30),
