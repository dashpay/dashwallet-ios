...
- (NSArray<NSString *> *)items {
    if (!_items) {
        _items = @[
            ...
            NSLocalizedString(@"If this device is lost / damaged, if the Dash Wallet is uninstalled accidentally from this device, you will need this recovery phrase to access your funds.", nil),
        ];
    }
