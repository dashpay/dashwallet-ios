...
- (NSArray<DWAlertAction *> *)providedActions {
    if (!_providedActions) {
        ...
        DWAlertAction *cancelAction = [DWAlertAction actionWithTitle:NSLocalizedString(@"OK", nil)
        ...
        DWAlertAction *seeOnUpholdAction = [DWAlertAction actionWithTitle:NSLocalizedString(@"See on Uphold", nil)
