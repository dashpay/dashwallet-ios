...
- (instancetype)initWithFrame:(CGRect)frame {
    ...
    if (self) {
        ...
        [NSLayoutConstraint activateConstraints:@[
            ...
            [tableView.topAnchor constraintEqualToAnchor:subContentView.topAnchor constant:verticalPadding],
            [tableView.bottomAnchor constraintEqualToAnchor:subContentView.bottomAnchor constant:-verticalPadding],
...
-(void)configureHierarchy {
    ...
    [NSLayoutConstraint activateConstraints:@[
        ...
        [stackView.topAnchor constraintEqualToAnchor:self.contentView.safeAreaLayoutGuide.topAnchor constant:12],
        [stackView.bottomAnchor constraintEqualToAnchor:self.contentView.safeAreaLayoutGuide.bottomAnchor constant:-4],
