...
func getAttributedTextWith(icon: UIImage, boldText: String, regularText: String, iconSize: CGSize, iconOffsetY: CGFloat) -> NSAttributedString {
    ...
    let textStr = NSAttributedString(string: " \(boldText) ", attributes: mediumFontAttribute)
    let regFontAttribute: [NSAttributedString.Key: Any] = [
        .font: UIFont.dw_regularFont(ofSize: 13)
    ]
    let timelineStr = NSAttributedString(string: regularText, attributes: regFontAttribute)
