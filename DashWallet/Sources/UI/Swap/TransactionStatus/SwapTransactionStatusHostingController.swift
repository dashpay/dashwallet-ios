...
// MARK: - SwapTransactionStatusHostingController
...
final class SwapTransactionStatusHostingController: UIViewController, NavigationBarDisplayable, NavigationStackControllable {
    ...
    override func viewDidLoad() {
        ...
        let statusView = SwapTransactionStatusView(
            viewModel: viewModel,
            onDone: { [weak self] in
...
// MARK: - SwapTransactionStatusView
...
private struct SwapTransactionStatusView: View {
