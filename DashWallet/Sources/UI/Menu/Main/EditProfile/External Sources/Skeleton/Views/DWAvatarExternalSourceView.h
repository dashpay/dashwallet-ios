...
@class DWAvatarExternalSourceView;

@protocol DWAvatarExternalSourceViewDelegate <NSObject>
...
@property (nullable, nonatomic, weak) id<DWAvatarExternalSourceViewDelegate> delegate;
