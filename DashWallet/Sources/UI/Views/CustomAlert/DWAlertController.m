...
- (void)performTransitionFromViewController:(UIViewController *)fromViewController
    ...
    CGFloat horizontalPadding = DWAlertViewContentHorizontalPadding;
    [NSLayoutConstraint activateConstraints:@[
        [toView.topAnchor constraintEqualToAnchor:contentView.topAnchor
                                         constant:verticalPadding],
        [toView.leadingAnchor constraintEqualToAnchor:contentView.leadingAnchor
                                             constant:horizontalPadding],
        [toView.bottomAnchor constraintEqualToAnchor:contentView.bottomAnchor
                                            constant:-verticalPadding],
        [toView.trailingAnchor constraintEqualToAnchor:contentView.trailingAnchor
                                              constant:-horizontalPadding],
    ]];
