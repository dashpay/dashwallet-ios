...
`WalletEnvironment` build-out (C1 categories 2/5) · ~~Transaction `.ds` deletion (C2)~~ **done 2026-07-06** · Payments zero-DS\* (C8 steps 2–5) · Auth replacement (C7, fixes Bugs #2/#3) · Utility tail — logger + **price pipeline** (C9) · CrowdNode signing app-side (C9/cov) · Uphold HTTP + keychain shims (cov) · Wallet presence + reinstall recovery (C6 A–D) · ~~CrowdNode online-account forward (C3 PR2)~~ done · ~~APY calculator port (C5 PR2)~~ done.
